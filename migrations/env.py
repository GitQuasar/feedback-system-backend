...
# Вручную импортируем переменную с НАШИМИ данными из config.py последующей замены
...
"""
Заменяем значение переменной sqlalchemy.url в файле alembic.ini на НАШЕ значение
